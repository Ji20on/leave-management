...
namespace leave_management.Controllers
{
    ...
    public class LeaveAllocationsController : Controller
    {
        ...
        public LeaveAllocationsController(ILeaveTypeRepository leaverepo, ILeaveAllocationRepository leaveallocationrepo, UserManager<Employee> userManager, IMapper mapper)
        {
